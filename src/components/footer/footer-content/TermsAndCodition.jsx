...
const Terms = () => {
  return (
    <div>
      ...
      <HomeContainer>
        <section className="text-white py-10 md:py-20 space-y-12">
          <h1 className="text-center text-4xl font-bold mb-4 text-white font-poltawski">
            Terms & Conditions
          </h1>

          <div className="space-y-8 text-sm text-gray-300 leading-8">
            <div>
            ...
            <div>
              <h2 className="text-xl font-semibold mb-4 text-white">2. About LAEATERY</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-semibold mb-4 text-white">3. Use of the Website</h2>
            ...
            <div>
              <h2 className="text-xl font-semibold mb-4 text-white">4. Restaurant Listings</h2>
              <p>
